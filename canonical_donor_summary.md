...
- llama: donor to 15 taxa, 484 borrowed traits
- qwen: donor to 9 taxa, 204 borrowed traits
- olmoe: donor to 6 taxa, 190 borrowed traits
- deepseek_v3: donor to 6 taxa, 210 borrowed traits
- gpt_oss: donor to 6 taxa, 162 borrowed traits
- gpt2: donor to 5 taxa, 202 borrowed traits
- gpt_neox: donor to 5 taxa, 127 borrowed traits
- mixtral: donor to 5 taxa, 188 borrowed traits
- plamo: donor to 4 taxa, 114 borrowed traits
- deepseek: donor to 4 taxa, 87 borrowed traits
- openelm: donor to 4 taxa, 110 borrowed traits
- qwen2_moe: donor to 4 taxa, 98 borrowed traits

## Borrow-Heavy Taxa

- dots1: donors bailing_moe(33), qwen2_moe(30), innovations none, score 10.30
- exaone_moe: donors afmoe(35), ministral3(28), innovations none, score 10.30
- Klear: donors dots1(40), nemotron_h(21), innovations shared_branch_merge_mode, coefficient_mix_shared_routed, score 12.10
- mimo_v2_flash: donors gpt_oss(31), glm4_moe(30), innovations rope_parameterization, score 11.10
- ernie4_5_moe: donors olmoe(35), nemotron_h(26), innovations none, score 10.10
- minimax: donors dots1(32), phixtral(29), innovations none, score 10.10
...
- hunyuan: donors dots1(35), qwen2_moe(25), innovations attention_projection, cross_layer_kv_sharing, positional_encoding, score 13.00
